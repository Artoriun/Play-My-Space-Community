...
public class ClassExtensions {
    ...
    {
        int volumen = Mathf.CeilToInt(rBounds.size.sqrMagnitude);
        return volumen;
    }
    ...
    public static bool BoundsIntersectVectors(Bounds rBounds, Vector3 origen, Vector3 direccion)
    {
    ...
    public static float HaltonSequence(int indice, int b)
    {
        float res = 0f;
        float f = 1f / b;
        int i = indice;
